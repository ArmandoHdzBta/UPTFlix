...
<body  style="background-color: <?PHP echo (isset($body) && $body == true)? 'white': 'white'; ?>">
    <p class="footer-country">UPTFLIX</p>
    <div class="our-story-card-text">
        <h1 id=""  class="our-story-card-title" data-uia="hero-title" color="blanco">Películas, programas de TV y más ilimitados..</h1>
        <h2 id="" class="our-story-card-subtitle" data-uia="our-story-card-subtitle">Mira en cualquier lugar.</h2>
        <form class="cta-form email-form" data-uia="email-form" method="GET">
            <h3 class="email-form-title">Ingrese su correo electrónico para crear o empezar su membresía..</h3>
            <div class="email-form-lockup"><ul class="simpleForm structural ui-grid">
                <li data-uia="field-email+wrapper" class="nfFormSpace field-email">
                    <div data-uia="field-email+container" class="nfInput nfInputResponsive">
                        <div class="nfInputPlacement"><label class="input_id" placeholder="email">
                            ...
                            <label for="id_email_hero_fuji" class="placeLabel">
                                ...
                                <button name="button">Correo electronico</button>
            ...
            <div class="our-story-card hero-card hero_fuji vlv" data-uia-our-story="hero_fuji" data-uia="our-story-card">
                <div class="our-story-card-background">
                    <div class="concord-img-wrapper" data-uia="concord-img-wrapper" style="height: 733px;">
                        <img class="concord-img vlv-creative" src="https://d500.epimg.net/cincodias/imagenes/2020/12/31/lifestyle/1609408585_467254_1609408795_noticia_normal.jpg" srcset="https://www.futuro.cl/wp-content/uploads/2021/05/netflix-1024x576.jpg" alt="">
        ...
        </div><div class="center-pixel" style="position:absolute"></div></div><div class="our-story-card animation-card watchOnTv" data-uia-our-story="watchOnTv" data-uia="our-story-card"><div class="animation-card-container">
            ...
            ><div class="our-story-card-animation-container">
                <div class="our-story-card-animation">
                    <video class="our-story-card-video" autoplay="" playsinline="" muted="" loop="">
                        ...
                        </video><div class="our-story-card-animation-text"></div></div></div></div><div class="center-pixel" style="position:absolute">
                        </div>
                        ...
                        <div class="our-story-card-text"><h1 id="" class="our-story-card-title" data-uia="animation-card-title">Descarga tus programas para verlos sin conexión.</h1>
                            <h2 id="" class="our-story-card-subtitle" data-uia="our-story-card-subtitle">Guarde y disfrute</h2>
                        </div><div class="our-story-card-img-container">
                            <div class="our-story-card-animation-container">
